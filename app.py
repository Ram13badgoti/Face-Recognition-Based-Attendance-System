...
def identify_face(facearray):
    ...
    # print(model.predict_proba(facearray))
    # conf = model.predict_proba(facearray)[0]
    # print(conf)
...
def start():
    ...
    while 1:
        ...
        #     cv2.putText(frame, f'Not available', (30, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 20), 2,
        #                 cv2.LINE_AA)
        #     break
